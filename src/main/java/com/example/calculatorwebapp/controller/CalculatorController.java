...
import com.example.calculatorwebapp.CalculatorService;
...
public class CalculatorController {
    ...
    public String divide (@RequestParam int num1,@RequestParam  int num2){
        if (num2 == 0){
            return "Второй аргумент 0 ,на ноль делить нельзя";
        }
    ...
    private String buildResponse (int num1,int num2,int result ,char action){
        return String.format("%d %c %d =%d",num1,num2,action,result);
    }
